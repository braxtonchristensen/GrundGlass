...
app.service('instagramService', function($http, $q){
	this.getFeed = function(){
		...
		$http({
			method: 'JSONP',
			url: 'https://api.instagram.com/v1/users/2212719053/media/recent?client_id=b82ac2ac9a884520b68a14ebdacfe6da&callback=JSON_CALLBACK'
